    ...
    const timespanSelector = timespanSelection.create(timespanSelection.timespans.twoWeeks),
        description = graphDescription.create({
            description: ["All flaky test cases.",
                          ...
                          "Multiple test cases with the same name have their flaky failure counts added up."].join(' '),
...
}(timespanSelection, graphDescription, jobColors, graphFactory, dataSource, weightedTimeline));
