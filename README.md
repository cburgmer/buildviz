...
## Usage
    ...
    $ curl -OL https://github.com/cburgmer/buildviz/releases/download/0.11.0/buildviz-0.11.0-standalone.jar
    $ java -jar buildviz-0.11.0-standalone.jar
...
E.g. sync existing history from GoCD (see `--help` for details):
    ...
    $ java -cp buildviz-0.11.0-standalone.jar buildviz.go.sync http://$USER:$PW@localhost:8153/go
