...
(def build-input-1 {:start 1 :inputs '({:revision "abcd" :source-id 21} {:revision "1" :source-id 42})})
(def another-build-input-1 {:start 2 :inputs '({:revision "abcd" :source-id 21} {:revision "1" :source-id 42})})
(def build-input-2 {:start 4 :inputs '({:revision "2" :source-id 42})})
